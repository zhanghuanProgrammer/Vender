...
- (UIPageControl *)pageControl {
    if (_pageControl == nil) {
        ...
        _pageControl.pageIndicatorTintColor=[UIColor getColor:@"#ebebeb"];
        _pageControl.currentPageIndicatorTintColor=RGB(50,174,186);
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row == self.images.count - 1) {
        ...
        [cell.clickView setHidden:NO];
        [cell.clickView addUITapGestureRecognizerWithTarget:self withAction:@selector(nextButtonHandler:)];
